...
class Mysqldump
{
    ...
    public static function get_pdo_dsn($type = "mysql", $host, $db_name) {
        $port = null;
        $socket = null;
            ...
            switch ($this->dbType) {
                ...
                case 'dblib':
                    $this->dbHandler = new PDO(
                        self::get_pdo_dsn($this->dbType, $this->host, $this->db),
                        $this->user,
                        $this->pass,
                        $this->pdoSettings
                    );
    ...
    private function listValues($tableName)
    {
        ...
        foreach ($resultSet as $row) {
            if ($this->dumpSettings['whereFct']) {
               $row = $this->dumpSettings['whereFct']($tableName, $row);
            }
