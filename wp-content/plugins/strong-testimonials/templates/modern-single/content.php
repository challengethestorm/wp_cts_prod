<?php
/**
 * Template Name: Modern-single
 * Description: A modern-single template designed for slideshows or single testimonials. Looks great with manual or automatic excerpts.
 * Styles: wpmtst-font-awesome
 */
?>
<!-- Strong Testimonials: Modern-single Template -->
