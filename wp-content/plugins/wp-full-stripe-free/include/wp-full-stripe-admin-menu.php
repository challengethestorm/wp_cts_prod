...
class MM_WPFSF_Admin_Menu
{
    ...
    {
        wp_register_style('fullstripe-css', plugins_url('/css/fullstripe.css', dirname(__FILE__)), null, MM_WPFSF::VERSION);
        wp_register_style('fullstripe-ui-css', plugins_url('/css/fullstripe-ui.css', dirname(__FILE__)), null, MM_WPFSF::VERSION);
    }
    ...
    function fullstripe_admin_scripts()
    {
        ...
        wp_enqueue_script( 'sprintf-js', plugins_url( 'js/sprintf.min.js', dirname( __FILE__ ) ), null, MM_WPFSF::VERSION );
        wp_enqueue_script('wp-full-stripe-admin-js', plugins_url('/js/wp-full-stripe-admin.js', dirname(__FILE__)), array('sprintf-js', 'jquery', 'stripe-js', 'jquery-ui-tabs', 'jquery-ui-core', 'jquery-ui-widget', 'jquery-ui-autocomplete', 'jquery-ui-button', 'jquery-ui-tooltip', 'jquery-ui-sortable'), MM_WPFSF::VERSION);
        ...
        wp_enqueue_style( 'fullstripe-css', plugins_url( '/css/fullstripe.css', dirname( __FILE__ ) ), null, MM_WPFSF::VERSION );
        wp_enqueue_style( 'fullstripe-ui-css', plugins_url( '/css/fullstripe-ui.css', dirname( __FILE__ ) ), null, MM_WPFSF::VERSION );
