...
class MM_WPFSF_Customer
{
    ...
    function fullstripe_payment_charge()
    {
        ...
        if ($isCustom == 1)
        {
            ...
            {
                $valid = false;
                $return = array('success' => false, 'msg' => __('The payment amount is invalid, please only use numbers and a decimal point.', 'wp-full-stripe-free'));
            }
            else
            {
        ...
        if ($showAddress == 1)
        {
            ...
            {
                $valid = false;
                $return = array('success' => false, 'msg' => __('Please enter a valid billing address.', 'wp-full-stripe-free'));
            }
        }
        ...
        if (isset($_POST['fullstripe_email']))
        {
           ...
           {
               $valid = false;
               $return = array('success' => false, 'msg' => __('Please enter a valid email address.', 'wp-full-stripe-free'));
           }
        }
