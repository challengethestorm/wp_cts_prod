...
class WPFSF_Payments_Table extends WP_List_Table
{
    ...
    function get_columns()
    {
        return $columns = array(
            'eventID' => __('Stripe ID', 'wp-full-stripe-free'),
            'description' => __('Description', 'wp-full-stripe-free'),
            'paid' => __('Paid', 'wp-full-stripe-free'),
            'livemode' => __('Live mode', 'wp-full-stripe-free'),
            'amount' => __('Amount', 'wp-full-stripe-free'),
            'fee' => __('Stripe Fee', 'wp-full-stripe-free'),
            'address' => __('Address', 'wp-full-stripe-free'),
            'created' => __('Date', 'wp-full-stripe-free')
        );
    }
