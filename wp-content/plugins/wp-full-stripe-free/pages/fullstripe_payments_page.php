...
?>
<div class="wrap">
    <h2> <?php echo __('Full Stripe Payments', 'wp-full-stripe-free'); ?> </h2>
                    ...
                    <table class="wp-list-table widefat fixed">
                        ...
                        <?php foreach ($paymentForms as $f): ?>
                            <tr>
                                ...
                                <?php endif; ?>
                                <td>
                                    <a class="button button-primary" href="<?php echo admin_url("admin.php?page=fullstripe-edit-form-f&form=$f->paymentFormID&type=payment"); ?>">Edit</a>
