<div class="wrap">
    ...
    <ol>
        <li>
            ...
            Please refer to <a href="http://www.gnu.org/software/gettext/manual/gettext.html#Locale-Names"
                               target="_blank">Locale names</a> section of the <code>gettext</code> utility manual for
            more information.
        </li>
        <li>
            Edit the "wp-content/plugins/wp-full-stripe-free/languages/wp-full-stripe-free-&lt;language code&gt;_&lt;country code&gt;.po"
            file:
            <ol>
        ...
        <li>
            Make sure that the newly created .mo file is in the "wp-content/plugins/wp-full-stripe-free/languages" folder and
    ...
    <p>If you require any more help with this plugin, you can always go to
        <a href="http://mammothology.com/forums">the Mammothology Support Forums</a> to ask your question, or email us
        directly at
        <a href="mailto:support@mammothology.com">support@mammothology.com</a></p>
    <div style="padding-top: 30px;">
        <h4>Notices</h4>
        <p>Please note that while every care has been taken to write secure and working code, Mammothology and Infinea Consulting Ltd.
