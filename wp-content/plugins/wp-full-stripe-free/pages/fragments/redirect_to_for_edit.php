...
<tr valign="top">
    ...
    <td>
        <label class="radio inline">
            <input type="radio" name="form_redirect_to" id="form_redirect_to_page_or_post" value="page_or_post" <?php echo ($editForm->redirectOnSuccess == '0') ? 'disabled' : '' ?> <?php echo ($editForm->redirectToPageOrPost == 1) ? 'checked' : '' ?>> Page or Post
        </label>
        <label class="radio inline">
            <input type="radio" name="form_redirect_to" id="form_redirect_to_url" value="url" <?php echo ($editForm->redirectOnSuccess == '0') ? 'disabled' : '' ?> <?php echo ($editForm->redirectToPageOrPost == 0) ? 'checked' : '' ?>> URL entered manually
        </label>
