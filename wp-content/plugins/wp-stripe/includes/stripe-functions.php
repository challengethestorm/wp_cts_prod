...
function wp_stripe_charge_initiate() {
		...
		try {
			...
			$result =  '<div class="wp-stripe-notification wp-stripe-success"> ' . sprintf( __( 'Success, you just donated %s', 'wp-stripe' ), '<span class="wp-stripe-currency">' . esc_html( $currency ) . '</span> ' . esc_html( $amount ) ) . ' !</div>';
