...
function wp_stripe_thickbox_imgs() { ?>
	<script type="text/javascript">
		var tb_pathToImage = "//challengethestorm.org/wp-content/themes/basic-child/loadingAnimation.gif";
		var tb_closeImage  = "//challengethestorm.org/wp-content/themes/basic-child/thickbox_close.png";
	</script>
<?php }
