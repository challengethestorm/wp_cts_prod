jQuery(document).ready(function() {
    ...
    var addShade = function() {
        ...
        if (shade.length > 0) {
            shade.remove();
            jQuery('#fancybox-wrap').append('<div id="shade" style="height:68px; width:' + jQuery('#fancybox-title').width() + 'px;"></div>');
        ...
        jQuery(this).extendLightbox({
            ...
            'titleFormat': function(title, currentArray, currentIndex, currentOpts) {
                ...
                var showControls = function() {
                    ...
                    var ligthboxControls = '<div class="lightbox-controls-inner">' + '<div class="lightbox-controls">';
                ...
                if (currentOpts.showCaption)
                    return '<div id="fancybox-title-over">' + '<div class="image-title">' + (title.length ? title : '') + '</div>' + '<div class="image-number">' + (currentIndex + 1) + ' / ' + currentArray.length + '</div>' + showControls() + '</div>' + clearfix;
                else
                    return '<div id="fancybox-title-over">' + '<div class="image-number">' + (currentIndex + 1) + ' / ' + currentArray.length + '</div>' + showControls() + '</div>' + clearfix;
